...
parser.add_argument("-ws", "--window-size", type=int, default=1, help="window-size for moving window average")
parser.add_argument("-fn", "--file-name", type=str, help="filename of logfile")
